...
_S["STATUS_TXT"] = {
    "en": (
        "<b>╭──────❰ 🤖 𝐁𝐨𝐭 𝐒𝐭𝐚𝐭𝐮𝐬 ❱──────╮\n"
        "┃\n"
        "┣⊸ 👨 ᴜsᴇʀs: <code>{users_count}</code>\n"
        "┣⊸ 🤖 ʙᴏᴛs: <code>{bots_count}</code>\n"
        "┣⊸ 📣 ᴄʜᴀɴɴᴇʟs: <code>{total_channels}</code>\n"
        "┣⊸ 🚫 ʙᴀɴɴᴇᴅ: <code>{banned_users}</code>\n"
        "┃\n"
        "┣⊸ 📡 Cᴜʀʀᴇɴᴛ Fᴏʀᴡᴀʀᴅs: <code>{current_forwards}</code>\n"
        "┃\n"
        "┣⊸ ⚡ Lɪᴠᴇ Fᴏʀᴡᴀʀᴅs: <code>{live_forward}</code>\n"
        "┣⊸ 📦 Bᴀᴛᴄʜ Fᴏʀᴡᴀʀᴅs: <code>{batch_forward}</code>\n"
        "┣⊸ 🚀 Nᴏʀᴍᴀʟ Fᴏʀᴡᴀʀᴅs: <code>{normal_forward}</code>\n"
        "┣⊸ 📊 Tᴏᴛᴀʟ Fᴏʀᴡᴀʀᴅs: <code>{total_forward}</code>\n"
        "┃\n"
        "┣⊸ ⬇️ Tᴏᴛᴀʟ Dᴏᴡɴʟᴏᴀᴅs: <code>{total_files_downloaded}</code> ғɪʟᴇs\n"
        "┣⊸ ⬆️ Tᴏᴛᴀʟ Uᴘʟᴏᴀᴅs: <code>{total_files_uploaded}</code> ғɪʟᴇs\n"
        "┣⊸ 💾 Tᴏᴛᴀʟ Dᴀᴛᴀ Usᴀɢᴇ: <code>{total_data_usage_bytes}</code>\n"
        "┃\n"
        "┣⊸ ⬇️ DL Sᴘᴇᴇᴅ: <code>{dl_speed}</code>\n"
        "┣⊸ ⬆️ UP Sᴘᴇᴇᴅ: <code>{ul_speed}</code>\n"
        "┃\n"
    ...
    "hi": (
        ...
        "┃\n"
        "┣⊸ ⬇️ कुल डाउनलोड्स: <code>{total_files_downloaded}</code> ғɪʟᴇs\n"
        "┣⊸ ⬆️ कुल अपलोड्स: <code>{total_files_uploaded}</code> ғɪʟᴇs\n"
        "┣⊸ 💾 कुल डेटा इस्तेमाल: <code>{total_data_usage_bytes}</code>\n"
        "┃\n"
        "┣⊸ ⬇️ DL स्पीड: <code>{dl_speed}</code>\n"
        "┣⊸ ⬆️ UP स्पीड: <code>{ul_speed}</code>\n"
        "┃\n"
    ...
    "hinglish": (
        ...
        "┃\n"
        "┣⊸ 📡 Abhi Chalu: <code>{current_forwards}</code>\n"
        "┃\n"
        ...
        "┃\n"
        "┣⊸ ⬇️ Total Downloads: <code>{total_files_downloaded}</code> ғɪʟᴇs\n"
        "┣⊸ ⬆️ Total Uploads: <code>{total_files_uploaded}</code> ғɪʟᴇs\n"
        "┣⊸ 💾 Total Data Usage: <code>{total_data_usage_bytes}</code>\n"
        "┃\n"
        "┣⊸ ⬇️ DL Speed: <code>{dl_speed}</code>\n"
        "┣⊸ ⬆️ UP Speed: <code>{ul_speed}</code>\n"
        "┃\n"
