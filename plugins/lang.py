...
_S["STATUS_TXT"] = {
    ...
    "hi": (
        ...
        "\n"
        "  »  कुल डाउनलोड्स: <code>{total_files_downloaded}</code> ғɪʟᴇs\n"
        "  »  कुल अपलोड्स: <code>{total_files_uploaded}</code> ғɪʟᴇs\n"
        "  »  कुल डेटा इस्तेमाल: <code>{total_data_usage_bytes}</code>\n"
        "\n"
        "  »  DL स्पीड: <code>{dl_speed}</code>\n"
        "  »  UP स्पीड: <code>{ul_speed}</code>\n"
        "\n"
    ...
    "hinglish": (
        ...
        "\n"
        "  »  Total Downloads: <code>{total_files_downloaded}</code> ғɪʟᴇs\n"
        "  »  Total Uploads: <code>{total_files_uploaded}</code> ғɪʟᴇs\n"
